...
\usepackage{lmodern}
\usepackage[top=.4cm, bottom=.3cm, left=.5cm, right=.5cm]{geometry}
...
\firstname{Yankel}
\familyname{Scialom}
\title{Ingénieur informatique junior}
...
\extrainfo{%
       ...
       26 ans --- permis B}
\photo[64pt]{ysc} 
\quote{Jeune ingénieur passionné, cherche emploi développement informatique}
\phone{+336 87 63 83 13}

\AtBeginDocument{
    \hypersetup{
       pdftitle      = {Yankel Scialom -- Ingénieur informatique junior - Linux/Android -- CV},
       pdfsubject    = {CV de Yankel Scialom},
       pdfkeywords   = {Yankel Scialom, CV, curriculum vitæ, CV, linux, développement, Ingénieur informatique junior, Java, C++, C, bash, shell, intégration, android}}
}
...
\cventry{2013--présent}{}{}{}{}{%
       \begin{cvcolumns}
              ...
              \cvcolumn{Autoformation}{%
                     Sécurité informatique et \textit{pentests}, mathématiques pour l'ingénieur,
...
%%
\cventry{2005--2012}{Professeur particulier et divers jobs d'été}{}{}{}{%
\begin{itemize}
