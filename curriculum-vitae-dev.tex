...
\cvlineWithMargin{Langages de développement}{%
       ...
       [My|Psotgre]SQL, PHP, HTML, CSS, Javascript, jQuery[-ui], ...).
}
...
%%
\cventry{2010}{Développeur junior}{\textsc{Thales Optronique} S.A.}{Elancourt}{France}{%
...
%%
\cventry{2005--2012}{Professeur particuliers et divers jobs d'été}{}{Troyes}{France}{%
\begin{itemize}
       \item Cours de remise à niveau et préparation au Baccalauréat en mathématiques,
              physique-chimie et biologie
       \item Écaissier, magasinier, vendeur, etc.
\end{itemize}
}
